...
def bb():
    ...
    if argument_value == "Seattle":
        ...
        frappe.db.commit()
        INR_items = frappe.get_list('Item', fields='item_name', filters={'item_group': 'Building Materials'})
        for i in INR_items:
        ...
        website_items = frappe.get_list('Website Item', filters={'item_group': 'Building Materials'})
