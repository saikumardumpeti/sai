window.onload = function() {
    ...
    const mainContainer = document.getElementById('cardContainer-drywall');

    selectedValue = selectElement.value;
    const url = `http://127.0.0.1:8002/api/method/library.www.drywalll.index.bb?argument=${selectedValue}`;
