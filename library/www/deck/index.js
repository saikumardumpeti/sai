window.onload = function() {
    ...
    const mainContainer = document.getElementById('cardContainer-deck');

    selectedValue = selectElement.value;
    const url = `http://127.0.0.1:8002/api/method/library.www.deck.index.bb?argument=${selectedValue}`;
